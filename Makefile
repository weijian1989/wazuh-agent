...
settings:
	...
	@echo "    OSSEC_CC      		${MING_BASE}${CC}"
	@echo "    OSSEC_CCBIN   		${MING_BASE}${CC}"
	@echo "    OSSEC_CXXBIN  		${MING_BASE}${CXX}"
	@echo "    OSSEC_SHARED  		${MING_BASE}${CC} -shared"
	@echo "    OSSEC_LINK    		${MING_BASE}ar -crus"
	@echo "    OSSEC_REMOVE_OBJECT  ${MING_BASE}ar -d"
	@echo "    OSSEC_RANLIB  		${MING_BASE}ranlib"
	@echo "    OSSEC_WINDRES 		${MING_BASE}windres"
